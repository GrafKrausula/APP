...
// == 2) Erstellen des Primärbaums und der Sekundärbäume =======================
                        ...
                        // Erstellen der Bäume
                        BSTree<CompRational> bst = new BSTree<CompRational>(cr);  // Primärbaum
                        BSTree<CompRational> bst1 = new BSTree<CompRational>(cr); // Sekundärbaum 1
                        BSTree<CompRational> bst2 = new BSTree<CompRational>(cr); // Sekundärbaum 2
...
// == 3) Ausgabe des Primärbaums und der Sekundärbäume auf der Konsole =========
                        ...
                        Iterator<CompRational> kk = bst.iterator();
                        if (kk.hasNext()) {
                                min_cr = kk.next(); // kleinste Zahl ermitteln
                                System.out.println("Knoten: " + min_cr);
                        }

                        // Rest Primärbaum
                        for (; kk.hasNext();) {
                                max_cr = kk.next(); // groesste Zahl ermitteln
                        ...
                        for (kk = bst1.iterator(); kk.hasNext();) {
                                System.out.println("Knoten: " + kk.next().toString() + " ");
                        }
